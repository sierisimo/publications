...
but I got some comments about it… I can resume those comments in just one:
...
When you write code you want to see it working, you want to see that magic formed in your mind working in the computer, you want to corroborate everything is ready for the next steps in your TURBO-SUPER-MEGA-AWESOME-PROJECT. But running the whole thing every single time, doing a compilation of the whole dependent code, passing previous screens/steps to arrive in the part you want to test, or simply adding one thousand _logs_ as part of the process to check everything works is annoying and takes a lot of time. Also, you need to do this for every big change (or even smaller changes) to validate this new thing doesn't break other stuff.
